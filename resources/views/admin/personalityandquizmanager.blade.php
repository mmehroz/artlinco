...
.test-list-btn{
  ...
  <main class="mains">
    <div class="container d-flex align-items-center justify-content-center text-center" style="margin-top: 390px;">
      ...
      <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/quizlist')}}">Quiz Manager </a></button>
      <!-- <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/teacherstats')}}">Dashboard</a></button> -->
        ...
        <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/testlist')}}">Personality Test</a></button>

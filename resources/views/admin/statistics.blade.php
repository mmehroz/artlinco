  ...
  <main class="mains">
    <div class="container d-flex align-items-center justify-content-center text-center" style="margin-top: 390px;">
      ...
      <div class="text-white mt-5" style="width: 100%;">
       <button for="actual-btn" class="btn materialbtn">   <a href="{{url('/testlist')}}">Overall Test Database</a></button>
      ...
      <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/userstatistics')}}">Specific Users</a></button>
      <!-- <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/teacherstats')}}">Dashboard</a></button> -->
        ...
        <button for="actual-btn" class="btn materialbtn userstatisbtn"><a href="{{url('/quizlist')}}">Quiz Database</a></button>
